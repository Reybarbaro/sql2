...
----------------------------------------------- SELECT --------------------------------------------------------
 ...
 /* Descripción: Esta consulta obtiene todos los registros de la tabla Clientes,
	...
	ID_Cliente, Nombre, Email, Teléfono, Fecha_Registro, y ID_Direccion.
 */
...
SELECT
	...
	Pedios_Productos.Cantidad,
	Pedidos. Fecha_Pedido
FROM Clientes
JOIN Pedios ON Clientes.IDCliente = Pedidos.ID_Cliente
...
/*
NOT LIKE:
	Se utiliza para excluir un patron en una cadena de texto.
*/
